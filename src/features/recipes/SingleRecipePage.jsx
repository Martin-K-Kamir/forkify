...
const SingleRecipePage = () => {
    ...
    if (isLoading) {
        ...
        return (
            <div className="text-center f-size-1 f-weight-medium text-red-600 text-red-100//dark flex align-items-center justify-content-center flex-direction-column gap-3xs">
